function playLottery() {
    alert("Redirecting to the lottery game...");
    // Here you can add code to redirect to the lottery game page
}
...
document.getElementById('enter').addEventListener('click', function() {
    window.location.href = 'https://remix.ethereum.org/#lang=en&optimize=false&runs=200&evmVersion=null&version=soljson-v0.8.25+commit.b61c2a91.js'; // Redirect to the desired page
});
